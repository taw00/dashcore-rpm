...
# missing files cuz this rev of 0.13.0.x is older than 0.12.1.x
Source3: %{extrasbasename}%{pedanticfiletag}-missing-files.tar.gz
...
%changelog
* Wed Apr 13 2016 Todd Warner <toddwarner@protonmail.com> 0.13.0.x-20160413.taw
- "dashcore" shall be the base package name.
- I also fixed some icons.
-
* Sun Apr 10 2016 Todd Warner <toddwarner@protonmail.com> 0.13.0.x-20160410.taw
...
-
* Tue Apr 05 2016 Todd Warner <toddwarner@protonmail.com> 0.13.0.x-20160405.0.taw
- Initial spec
-

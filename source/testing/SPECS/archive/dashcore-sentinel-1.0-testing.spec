...
# For example, sentinel-1.0.2.tar.gz
%define _archivebasename1 %{_name1}-%{version}
# Used for other things. dashcore-sentinel-1.0
...
automating Dash v12.2 governance objects and tasks, and for expanded functions

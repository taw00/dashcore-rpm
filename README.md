...
dashcore-sentinel - latest version-release: 0.12.1-test.3.taw

* Fedora Linux 24:
  - `dashcore-0.12.1-test.b00785.0.taw.fc24.src.rpm`
  - `dashcore-sentinel-0.12.1-test.3.taw.fc24.src.rpm`
* Fedora Linux 25:
  - `dashcore-0.12.1-test.b00785.0.taw.fc25.src.rpm`
  - `dashcore-sentinel-0.12.1-test.3.taw.fc25.src.rpm`
* CentOS and RHEL 7:
  - `dashcore-0.12.1-test.b00785.0.taw.el7.centos.src.rpm`
  - `dashcore-sentinel-0.12.1-test.3.taw.el7.centos.src.rpm`

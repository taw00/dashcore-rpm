...
%changelog
* Fri Dec 30 2016 Todd Warner <t0dd_at_protonmail_dot_com> 0.12.0.58-2.taw
...
-
* Mon Jun 13 2016 Todd Warner <t0dd_at_protonmail_dot_com> 0.12.0.58-1.taw
- Added gcc-c++ to the BuildRequires
-
- The only release note for this version, so I include it here.
- From the core dev team:
- This version is a maintenance release of the Dash Core 0.12.0.x series
- In this minor release only bugfixes have been included and we consider this a
- stable release.
-

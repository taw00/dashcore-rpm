...
Source0: https://github.com/dashpay/sentinel/archive/v%{version}/%{sourcetree}.tar.gz
Source1: https://github.com/taw00/dashcore-rpm/raw/master/SOURCES/%{sourcetree_contrib}.tar.gz
#Patch0: https://github.com/taw00/dashcore-rpm/raw/master/SOURCES/%%{_name_s}-%%{vermajor}-fix-SyntaxWarning.patch
...
%if 0%{?fedora}
BuildRequires: python3.9 python3-virtualenv
%else
BuildRequires: python3.9 /usr/bin/virtualenv-3
%endif
...
cd %{sourcetree}
[ -f /usr/bin/virtualenv-3 ] && /usr/bin/virtualenv-3 -p python3.9 ./venv || /usr/bin/virtualenv -p python3.9 ./venv
...
* Tue Nov 9 2021 Todd Warner <t0dd_at_protonmail.com> 1.6.0-1.2.testing.taw
  ...
  - forcing python 3.9 in order support Fedora 35
  - using define "isTestBuild" rather than "targetIsProduction" because the  
    word production is problematic
  - removed patch that quieted the build system. No longer a nuisance, it seems.
